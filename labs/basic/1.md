...
### <font color='red'><b>This Lab is based on the GA release 1.3. The url for API call in "DevNet APIC-EM GA 1.3 always on sandbox" is https://devnetapi.cisco.com/sandbox/apic_em</b><br></font>
...
This lab uses the Cisco APIC-EM controller that the [Cisco DevNet Always-On Sandbox](https://developer.cisco.com/sandbox/apic_em) provides. To use a different controller, set the **apicem_ip** variable in the **apicem_config.py** file appropriately. For more information, **see** the "Getting Started" section of this lab.
