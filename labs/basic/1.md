...
This lab uses the Cisco APIC-EM controller that the [Cisco DevNet Sandbox](https://developer.cisco.com/sandbox) provides. To use a different controller, set the **apicem_ip** variable in the **apicem_config.py** file appropriately. For more information, **see** the "Getting Started" section of this lab.
