...
This lab uses the Cisco APIC-EM controller that the [Cisco DevNet Always-On Sandbox](developer.cisco.com/sandbox/apic_em) provides. To use a different controller, set the **apicem_ip** variable in the **apicem_config.py** file appropriately. For more information, *see* the "Getting Started" section of this lab.
