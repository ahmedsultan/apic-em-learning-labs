...
Alternatively, you can use Python IDE - IDLE.<br> In Mac OS Terminal just type "idle3" that will bring up IDLE for Pyhton3.<br>In Windows you can start IDLE from Start menu. See the following figure.</b><br></font>
