...
*  If you cannot find downloaded sample codes you can create your working directory by typing "mkdir \apicem-1.3-LL-sample-codes\basic-labs\<UniqueName>".<br><br>
...
1. Open a terminal and switch to the directory that holds the learning lab sample code.  Typically, the**`apicem-1.3-LL-sample-code\basic-labs`**is your working directory(Windows PC).
2. Invoke Python3 as appropriate for your OS:<br>
####<font color='red'><b>Python version 3.x is required to run sample scripts</b><br></font>
...
###### <font color='red'><b>Note: Alternatively you can use Python IDE - IDLE.<br> In Mac OS or Linux just type "idle3" that will bring up IDLE for Pyhton3<br>In Windows you can start IDLE from program menu. See the following figure.</b><br></font>

![Figure](/posts/files/apic-em-1-3-basic/idle.jpg)
