...
Alternatively you can use Python IDE - IDLE.<br> In Mac OS or Linux just type "idle3" that will bring up IDLE for Pyhton3<br>In Windows you can start IDLE from program menu. See the following figure.</b><br></font>
