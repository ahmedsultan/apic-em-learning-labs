# APIC-EM REST API - Command Runner

## Objective

Completion Time: 20 minutes

* Learn about and how to use command runner APIs
* Write custom scripts using Python


## Prerequisites
* We recommend strongly you start from Part I 
* This Lab is based on the APIC-EM release 1.4.
* The url for API call in "DevNet APIC-EM GA 1.4 always on sandbox" is https://devnetapi.cisco.com/sandbox/apic_em. This url is used for API call only, not for UI access.
...
*  Lab files are already downloaded into working directory: **C:\apicem-LL-sample-codes\command-runner-labs**
*  If you cannot find downloaded sample codes you can create your working directory by typing "mkdir \apicem-LL-sample-codes\command-runner-labs\<UniqueName>".<br><br>
...
*  Download the lab files from GitHub :
 ...
 ```
 git clone https://github.com/CiscoDevNet/apicem-LL-sample-codes
 ```
...
1. Open a terminal and switch to the directory that holds the learning lab sample code. Typically, the `\apicem-LL-sample-codes\policy-labs` is your working directory.
...
![Figure](/posts/files/apic-em-command-runner/idle.jpg)
...
* **Lab 1: Command runner related APIs - Find out what are available IOS command for APIC-EM API call**
