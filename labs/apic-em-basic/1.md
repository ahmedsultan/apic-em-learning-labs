...
You will make API calls to an APIC-EM controller. By default, these labs use the [Cisco DevNet Sandbox’s](https://developer.cisco.com/site/devnet/sandbox/) APIC-EM controller at https://sandboxapic.cisco.com/.
...
Download and install [Requests: HTTP for Humans](http://docs.python-requests.org/en/latest/) for your apprpriate operating system. Installing this library will allow you to make REST calls from within your Python scripts.
