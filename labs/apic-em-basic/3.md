...
For simplicity, you place the `tabulate.py` file in the same directory as the sample code.
...
Now that you have the device id, you can pass it to `GET /network-device/{id}/config` to retrieve the IOS configuration of the device that the user chose.
